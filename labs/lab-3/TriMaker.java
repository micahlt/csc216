...
public class TriMaker extends ShapeMaker {
    // Create the object. Send the display context to the base class
    public TriMaker(DisplayContext c) {
        super(c);
    }
    ...
    void generate() {
        ...
        double width = dimX();
        double height = dimY();
        double topLeftX = cornerX();
        double topLeftY = cornerY();
        ...
        el.getPoints().addAll(new Double[] {
                topLeftX + (.5 * width), topLeftY,
