...
class Util { 
    ...
    // properly, because of the way Java generics are broken.  It has all
    // the information it needs to check the cast, but says it won't  Java
    // had a good type system until generics.  Might possbily be able to
    // create an empty super-interface for Sorter and Searcher, but not
    // sure it work, and sure it would be a pain.
    ...
    public static <T> T get_tested_object(String clname, Class iface,
                                          boolean announce)
    {
        ...
        try {
            return (T)iface.cast(tested_class.
